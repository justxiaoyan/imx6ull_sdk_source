...
deps_config := \
	...
	drivers/iio/temperature/p3t/Kconfig \
	drivers/ntb/Kconfig \
...
ifneq "$(KERNELVERSION)" "6.12.3"
$(autoconfig): FORCE
endif

ifneq "$(CC)" "arm-buildroot-linux-gnueabihf-gcc"
$(autoconfig): FORCE
endif

ifneq "$(LD)" "arm-buildroot-linux-gnueabihf-ld"
$(autoconfig): FORCE
endif
...
ifneq "$(CC_VERSION_TEXT)" "arm-buildroot-linux-gnueabihf-gcc.br_real (Buildroot 2024.08-git) 13.3.0"
$(autoconfig): FORCE
endif

ifneq "$(NM)" "arm-buildroot-linux-gnueabihf-nm"
$(autoconfig): FORCE
endif

ifneq "$(OBJCOPY)" "arm-buildroot-linux-gnueabihf-objcopy"
$(autoconfig): FORCE
endif
...
ifneq "$(AR)" "arm-buildroot-linux-gnueabihf-ar"
$(autoconfig): FORCE
endif
